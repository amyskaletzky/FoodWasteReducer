...
const HomePage = (props) => {
    ...
    return (
        <div className=''>
            <NavBar />
            <p className="font-semibold text-3xl mb-6 text-teal-100 tracking-tight">No Food Left Behind</p>

            <form className='text-teal-200' onSubmit={handleAction}>
                ...
                <label className='text-xl font-semibold' htmlFor='extras'>If you have any any extra notes, please write them here:</label><br />
                ...
                <input className='duration-300 px-4 py-2 bg-orange-100 text-lg font-semibold text-teal-800 rounded-full' type='submit' value='Submit' />
            </form>

            <div className='w-full h-full bg-teal-700'>
                <div class="border bg-orange-200 border-blue-300 shadow rounded-md p-4 max-w-sm w-full mx-auto">
                    <div class="animate-pulse flex space-x-4">
                        <div class="flex-1 space-y-6 py-1">
                            <div class="h-7 text-orange-100 bg-teal-600 rounded">Loading Recipe...</div>
