                    ...
                    <div className='w-full flex flex-col'>
                        ...
                        <div className=" w-full max-w-xs m-auto">
                            <form className=" bg-gradient-to-r from-orange-200 to-amber-200 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                <div className="mb-4">
                                    <label className="block text-teal-500 text-2xl font-bold mb-2" htmlFor="username">
                                        Username
                                    </label>
                                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 text-xl leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username" onChange={(e) => setUsername(e.target.value)} />
                                </div>
                                <div className="mb-6">
                                    <label className="block text-teal-500 text-2xl font-bold mb-2" htmlFor="password">
                                        Password
                                    </label>
                                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 text-xl leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="******************" onChange={(e) => setPassword(e.target.value)} />
                        ...
                        <form className="w-full max-w-lg m-auto bg-gradient-to-r from-orange-200 to-amber-200 shadow-md rounded px-8 pt-6 pb-8">
                            <div className="flex flex-wrap -mx-3 mb-6">
                                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label className="text-teal-500 block uppercase tracking-wide text-xl font-bold mb-2" htmlFor="grid-first-name">
                                        First Name
                                    </label>
                                ...
                                <div className="w-full md:w-1/2 px-3">
                                    <label className="block uppercase tracking-wide text-teal-500 text-xl font-bold mb-2" htmlFor="grid-last-name">
                                        Last Name
                                    </label>
                            ...
                            <div className="flex flex-wrap -mx-3 mb-6">
                                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label className="block uppercase tracking-wide text-teal-500 text-xl font-bold mb-2" htmlFor="grid-username">
                                        Username
                                    </label>
                                ...
                                <div className="w-full md:w-1/2 px-3">
                                    <label className="block uppercase tracking-wide text-teal-500 text-xl font-bold mb-2" htmlFor="grid-email">
                                        Email
                                    </label>
                            ...
                            <div className="flex flex-wrap -mx-3 mb-2">
                                <div className="w-full px-3">
                                    <label className="block uppercase tracking-wide text-teal-500 text-xl font-bold mb-2" htmlFor="grid-password">
                                        Password
                                    </label>
                            ...
                            <div className="flex flex-wrap -mx-3 mb-2">
                                <div className="w-full px-3">
                                    <label className="block uppercase tracking-wide text-teal-500 text-xl font-bold mb-2" htmlFor="grid-password2">
                                        Confirm Password
                                    </label>
                                ...
                                {!passwordsMatch && <p className='italic text-red-600 text-lg mx-auto'>Passwords do not match.</p>}
                            </div>
                            <div className="flex items-center justify-evenly">
                                {/* justify-between if adding the forgot password */}
                                <button className="bg-teal-500 text-xl hover:bg-teal-700 hover:scale-110 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" onClick={() => handleAction(props.title)}>
                                    Sign Up
                                </button>
                                <button type="button" className="inline-block align-baseline text-2xl text-teal-500 hover:text-teal-800" onClick={() => handleAction('goLog')}>
                                    Log In
                                </button>
